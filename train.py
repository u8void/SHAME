...
def run_torch_path(args, device_type: str):
    ...
    encodings = tokenizer(texts, truncation=True, max_length=512, padding="max_length", return_tensors="pt")
