...
- GENERAL: Casual chat, greetings (hi, hello), identity.
- MATH: Math problems.
- CODE_SIMPLE: Single functions, HTML, canvas.
- CODE_COMPLEX: Full projects.
- CONTROL: System commands, apps, browser automation.
"""
        ...
        response_format={
            ...
            "schema": {
                ...
                "properties": {
                    "route": {
                        "type": "string", 
                        "enum": ["SEARCH", "REASONING", "GENERAL", "MATH", "CODE_SIMPLE", "CODE_COMPLEX", "CONTROL"]
                    },
                    "search_keywords": {
                        "type": "string"
                    }
