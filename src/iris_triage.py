...
try:
    ...
    TRIAGE_SYSTEM_PROMPT = (
        ...
        "  [ROUTE: MATH]              — math problems, equations, proofs, calculations, math concept explanations, differential equations, calculus, algebra, geometry, combinatorics, math word problems, math professor roleplay\n"
        ...
        "CRITICAL: Any query asking to solve a math problem, word problem, or explaining a math concept MUST go to [ROUTE: MATH]."
    )
