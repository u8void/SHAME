...
orig_load = src.iris.load_generation_config
def mock_load():
    cfg = orig_load()
    cfg["speculative_decoding"]["enabled"] = False
    return cfg
src.iris.load_generation_config = mock_load

import time

def test():
    print("Loading reasoning model without speculative decoding...")
