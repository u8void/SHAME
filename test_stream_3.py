from src.iris import _stream_tokens, ModelRole, TaskType, load_model
...
User Query: talk about the giza pyramids

INSTRUCTIONS: You MUST think step-by-step inside a <think> block before answering. Use the search results above to inform your answer, especially for recent events or specific facts. If the search results are incomplete, you may use your internal knowledge to supplement the answer. Respond in the SAME LANGUAGE as the user's query."""
